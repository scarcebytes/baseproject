...
export default function TokenAccountCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new TokenAccount(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "TokenAccountCreateForm")}
      {...rest}
    >
      <TextField
        label="Link"
